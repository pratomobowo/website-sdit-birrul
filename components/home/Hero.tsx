    ...
    <section className="relative w-full flex flex-col items-center justify-center bg-emerald-50/50 pt-20 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 pointer-events-none overflow-hidden z-0">
        ...
        <motion.div
           ...
           className="absolute bottom-[38%] -left-[25%] sm:bottom-0 sm:-left-8 lg:-left-16 w-[220px] sm:w-[300px] lg:w-[450px] z-10"
        >
          <Image 
            src="/2.png" 
        ...
        <motion.div
           ...
           className="absolute bottom-[38%] -right-[25%] sm:bottom-0 sm:-right-8 lg:-right-16 w-[220px] sm:w-[300px] lg:w-[450px] z-10"
        >
          <Image 
            src="/1.png" 
